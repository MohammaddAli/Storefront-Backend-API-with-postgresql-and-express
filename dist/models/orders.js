...
exports.storefrontOrder = void 0;
var database_1 = __importDefault(require("../database"));
var storefrontOrder = /** @class */ (function () {
    function storefrontOrder() {
    }
    storefrontOrder.prototype.index = function () {
    ...
    storefrontOrder.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get order ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    storefrontOrder.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    storefrontOrder.prototype.update = function (id, order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot update order ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    storefrontOrder.prototype["delete"] = function (id, order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Cannot get order ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    storefrontOrder.prototype.addProduct = function (orderProduct) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Cannot get orderProducts ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    storefrontOrder.prototype.currentOrder = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_7 = _a.sent();
                        throw new Error("Cannot get the current order for the user with id".concat(user_id, ",  ").concat(err_7));
                    case 4: return [2 /*return*/];
                }
            });
        });
...
exports.storefrontOrder = storefrontOrder;
